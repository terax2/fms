...
#define DEFAULT_MYSQL_HOME "/usr/local/server/mysql"
#define SHAREDIR "/usr/local/server/mysql/share"
#define DEFAULT_BASEDIR "/usr/local/server/mysql"
#define MYSQL_DATADIR "/usr/local/server/mysql/data"
#define DEFAULT_CHARSET_HOME "/usr/local/server/mysql"
#define PLUGINDIR "/usr/local/server/mysql/lib/plugin"
#define DEFAULT_SYSCONFDIR "/usr/local/server/mysql/etc"
...
#define PACKAGE_STRING "MySQL Server 5.5.20"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "5.5.20"
